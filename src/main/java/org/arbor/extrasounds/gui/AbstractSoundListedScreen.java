    ...
    protected void addDoneButton(boolean withCancel) {
        ...
        if (withCancel) {
            this.addRenderableWidget(
                    new Button(this.width / 2 - 155, this.height - 27, 150, 20, CommonComponents.GUI_DONE,
                            (button) -> {
            ...
            this.addRenderableWidget(
                    new Button(this.width / 2 - 155 + 160, this.height - 27, 150, 20, CommonComponents.GUI_CANCEL,
                            (button) -> this.minecraft.setScreen(this.lastScreen))
            );
        } else {
            this.addRenderableWidget(
                    new Button(this.width / 2 - 100, this.height - 27, 200, 20, CommonComponents.GUI_DONE,
                            (button) -> {
                                this.minecraft.options.save();
                                this.minecraft.setScreen(this.lastScreen);
                            })
