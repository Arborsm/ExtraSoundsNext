...
package dev.arbor.extrasoundsnext.core.gui;
...
import dev.arbor.extrasoundsnext.core.sounds.SoundSouceInit;
...
public class CustomSoundOptionsScreen extends AbstractSoundListedScreen {
    ...
    protected void addOptions() {
        ...
        this.list = this.layout.addToContents(new SoundList(this.minecraft, this.width, this.layout.getContentHeight(),
                this.layout.getHeaderHeight(), 25));
